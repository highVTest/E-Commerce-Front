                            ...
                            >
                                {
                                    reviews.map((review) => {
                                        return(
                                            ...
                                            <Grid
                                                style={{ backgroundColor: "beige", height:"280px", justifyContent:"center"}}
                                                key={review.id}
                                            >
                                                <Fieldset style={{marginLeft:"20px", marginTop:"30px"}}>
                                                    ...
                                                    <Group gap="xs" grow style={{ margin:"10px", width: "1080px", height:"200px"}}>
                                                        <Grid.Col span={3}>
                                                            <Image
                                                        ...
                                                        <Grid.Col span={6}>
                                                            <Stack align="flex-start" justify="center" gap="md">
                                                                <Text fw={1000} size="xl">상품 명 : {review.productName}</Text>
                                                                <Text fw={1000} size="xl">내가 작성한 리뷰 : {review.content} </Text>
                                                                <Text fw={1000} size="lg">내가 준 평점 : {review.rate} 점</Text>
                                                            </Stack>
                                                        </Grid.Col>
                                                        <Grid.Col span={1}>
                                                            <Stack>
                                                                <ReviewUpdateModal token={token} reviewId={review.id} productId={review.productId}/>
                                                                <Button
                                                                    color="red"
                                                                    // fullWidth
                                                                    mt="md"
