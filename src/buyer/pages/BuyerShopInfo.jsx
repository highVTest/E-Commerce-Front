import {Button, Container, Grid, Image, Modal, Rating, Stack,} from "@mantine/core";
...
const BuyerShopInfo = ({product}) => {
    ...
    return (
        <>
                                    ...
                                    <div className="shop-info" style={{width: "450px"}}>
                                        ...
                                        >
                                            ...
                                            <Grid>
                                                ...
                                                <Grid.Col span={8}>
                                                    <Rating value={shopData.rate} fractions={2} readOnly size="lg"/>
                                                </Grid.Col>
                                                <Grid.Col
                                                    span={4}
                                                    style={{alignContent: "center", textAlign: "center"}}
            ...
            <Button onClick={open} style={{marginTop: "16px", marginLeft: "10px"}}> 싱점 정보 보기</Button>
        </>
    );
};
